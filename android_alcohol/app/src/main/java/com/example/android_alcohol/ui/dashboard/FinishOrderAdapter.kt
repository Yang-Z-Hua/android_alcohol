...
import kotlinx.android.synthetic.main.finish_order_detail.view.*
import kotlinx.android.synthetic.main.finish_order_detail.view.alcohol_choosed
import kotlinx.android.synthetic.main.finish_order_detail.view.alcohol_inventory
import kotlinx.android.synthetic.main.finish_order_detail.view.brand_name
import kotlinx.android.synthetic.main.finish_order_detail.view.dynamic_name
import kotlinx.android.synthetic.main.finish_order_detail.view.order_time
import kotlinx.android.synthetic.main.finish_order_detail.view.sales
import kotlinx.android.synthetic.main.finish_order_detail.view.user_phone
import kotlinx.android.synthetic.main.order_detail.view.*
import java.text.SimpleDateFormat
import java.util.*

//private val mList: List<*>
class FinishOrderAdapter internal constructor( private val mList: List<ListDetail> ) : RecyclerView.Adapter<FinishOrderAdapter.MyHolder>() {
    val format = SimpleDateFormat("yyyy-MM-dd HH:mm:ss")
    //创建ViewHolder并返回，后续item布局里控件都是从ViewHolder中取出
    override fun onCreateViewHolder( parent: ViewGroup, viewType: Int ): MyHolder {
        //将我们自定义的item布局R.layout.item_one转换为View
        val itemView: View = LayoutInflater.from(parent.context)
            .inflate(R.layout.finish_order_detail, parent, false)
